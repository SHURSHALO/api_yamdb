    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_code', models.CharField(default='AAAA', max_length=260, null=True, verbose_name='Код подтверждения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Оценка должна быть не менее 1.'), django.core.validators.MaxValueValidator(10, message='Оценка должна быть не более 10.')], verbose_name='Оценка')),
